            ...
            <?php 
                ...
                if($count>0)
                {
                    ...
                    while($row=mysqli_fetch_assoc($res))
                    {
                        ...
                        <a href="<?php echo SITEURL; ?>/ordersection/category-drink.php?category_id=<?php echo $id; ?>">
                            <div class="box-3 float-container1">
                                ...
                                <?php 
                                    ...
                                    else
                                    {
                                        //Image Available
                                        ?>
                                        <img style="width:100%" src="<?php echo SITEURL; ?>images/category/<?php echo $image_name; ?>" alt="Pizza" class="img-responsive img-curve">
                                        <?php
                                    }
                                ?>
...
//SQL Query
$sql = "SELECT * FROM tbl_drinks WHERE active='Yes' AND featured='Yes' LIMIT 6";
            ...
            <div class="omg-menu-img">
                <?php 
                    ...
                    else
                    {
                        //Image Available
                        ?>
                        <img src="<?php echo SITEURL; ?>/images/drinks/<?php echo $image_name; ?>" alt="Image not Available" class="img1">
                        <?php
                    }
                ?>
                 </div>
